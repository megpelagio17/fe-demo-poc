...
export default class DefaultGaming extends React.Component {
  constructor(props) {
    super();
    this.state = {
      activeModal: null,
    ...
    return (
      <div class="body">
        <div _ngcontent-kar-c152="" class="product-header">
          <h1 _ngcontent-kar-c152="" class="heading v1-heading">
            Gaming
          </h1>
        </div>
        <div
          ...
          <div class="product-selections" _ngcontent-bqf-c89="">
            <div class="product-grid" _ngcontent-bqf-c89="">
              <div class="container" _ngcontent-bqf-c89="">
                {this.state.category
                  .filter((category) => category.categoryId == "160")
                  .map((fcategory, index) => {
                    return index <= 20 ? (
                      <div
                          ...
                          <div class="product-item" _ngcontent-bqf-c89="">
                            {(() => {
                              if (fcategory.products[0].outOfStock == false) {
                                ...
                                fcategory.products[0].outOfStock == true
                              ) {
                                console.log(
                                  fcategory.products[0].outOfStock +
                                    fcategory.name
                                );
                                return (
                                  <div class="image" _ngcontent-bqf-c89="">
                                    ...
                                    <div
                                      _ngcontent-adq-c89=""
                                      class="tags oos ng-star-inserted"
                                    >
                                      <span
                                        _ngcontent-adq-c89=""
                            ...
                            <div class="product-name" _ngcontent-lgs-c89="">
                              {fcategory.name}
                            </div>
                          ...
                          if (fcategory.products[0].outOfStock == false) {
                            return (
                              <ProductItem
                                ...
                                id={fcategory.id}
                                name={fcategory.name}
                                price={fcategory.products[0].currentPrice
                                  .priceOptions[0].upfrontPrice}
                              />
                            );
                          } return(
